...
const DateFilterBar = ({ filter, onChange, isLoading = false }) => {
  return (
    <div className="rounded-[2rem] border border-slate-200 bg-white/95 p-5 shadow-sm ring-1 ring-slate-100">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-500">Date Filter</p>
          <h2 className="mt-2 text-xl font-semibold text-slate-900">Performance Window</h2>
